...
StructMember::StructMember(const std::string &n, const std::string &s, EGlslSymbolType t, EGlslQualifier q, TPrecision prec, size_t as, GlslStruct* st, const std::string &bn) :
